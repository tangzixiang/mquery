...
func TestQuery_Encode(t *testing.T) {
	...
	assert.Equal(t, queryString, New().Add("name", "tom").Add("age", "15").Encode())
	assert.Equal(t, queryString, New().AddPairs("name", "tom", "age", "15").Encode())
	assert.Equal(t, queryString, New().AddByM(map[string]string{"name": "tom", "age": "15"}).Encode())
}
...
func TestQuery_AppendToURI(t *testing.T) {
	...
	assert.Equal(t, path, New().Add("name", "tom").Add("age", "15").AppendToURI("http://localhost?"))
...
func TestQuery_AppendToURIFormat(t *testing.T) {
	...
	assert.Equal(t, path, New().Add("name", "tom").Add("age", "15").AppendToURIFormat("http://localhost/users/%v?", 1))
	assert.Equal(t, path, New().AddPairs("name", "tom", "age", "15").AppendToURIFormat("http://localhost/users/%v", 1))
}
...
func TestQuery_SetPairsD(t *testing.T) {
	...
	path := "http://localhost/users/1?" + urlValues.Encode()
	generatePath := New().SetPairsD(func() []string { // lazy dynamic
		var pairs []string
...
func TestQuery_AddPairsD(t *testing.T) {
	...
	path := "http://localhost/users/1?" + urlValues.Encode()
	generatePath := New().AddPairsD(func() []string { // lazy dynamic
		var pairs []string
...
func TestQuery_Len(t *testing.T) {
	...
	assert.Equal(t, 2, New().WithIf(true, urlValues).Len())
}
...
func TestQuery_ParseForm(t *testing.T) {
	...
	q := New().ParseForm("name=tom&age=15")
...
func TestQuery_Values(t *testing.T) {
	...
	values := New().With(urlValues).Values()
